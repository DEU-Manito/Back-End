...
<script>
    function displayUserLocation(){
        ...
        articleApi.displayArticleList(lat, lng);
        <% } %>
    }
</script>
...
<div class="chat_container">
    <div class="app-header">
        <div class="app-header-left">
            ...
            <p class="app-name">Manito Chat</p>
    ...
    <div class="app-content">
        ...
        <div class="projects-section">
            ...
            <div class="project-boxes kakao_map_container" style="position: relative">
                <!-- 지도를 표시할 div 영역 -->
                <div id="map" style="width:100%;height: 90%; position: relative;">
                    <div class = "btn_container">
                        <!-- 도움 요청 게시글 버튼 -->
                        <div class = "help_btn" onclick="window.location = '/articles/create'">
                ...
                <h3 id="showArticleBtn" onclick="showArticles();">도움 게시글 보기</h3>
                <h3 id="showChattingBtn" onclick="showChatting();">채팅 보기</h3>
            </div>
...
<script>
    function showArticles(){
        $(".article_marker").show();
        $(".chat_room_marker").hide();
    }

    function showChatting(){
        $(".article_marker").hide();
        $(".chat_room_marker").show();
    }
</script>
