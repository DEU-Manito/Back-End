...
<header id="header_outer">
  <div class="container">
    <div class="header_section">
      <div class="logo"><a href="index.jsp"><img src="resources/img/manitoLogo.png" alt=""></a></div>
      ...
      <div class="row">
        <div class="col-lg-4">
          <div class="service_block">
            <div class="service_icon delay-03s animated wow  zoomInLeft"> <span><i class="fa fa-street-view"></i></span> </div>
        ...
        <div class="col-lg-4">
          <div class="service_block">
            <div class="service_icon icon2  delay-03s animated wow zoomInDown"> <span><i class="fa-solid fa-comments"></i></span> </div>
        ...
        <div class="col-lg-4">
          <div class="service_block">
            <div class="service_icon icon3  delay-03s animated wow zoomInRight"> <span><i class="fa-solid fa-hand-holding-hand"></i></span> </div>
  ...
  <div class="client_area ">
    <div class="client_section animated  fadeInUp wow">
      ...
      <div class="quote_section">
        ...
        <p><b><img src="resources/img/quote_sign_left.png" alt=""></b> Proin iaculis purus consequat sem cure  digni ssim donec porttitora entum suscipit rhoncus. Accusantium quam, ultricies eget id, aliquam eget nibh et. Maecen aliquam, risus at semper. <small><img src="resources/img/quote_sign_right.png" alt=""></small> </p>
      </div>
      <div class="clear"></div>
    </div>
        ...
        <div class="col-lg-3 mb-4 flipInY wow animated">
          ...
          <div class="row" style="text-align: center">
            <div class="col-md-12">
              ...
              <img src="resources/img/team_profile/kim_zoon.jpg" alt="wrapkit" class="img-fluid rounded-circle" />
            </div>
        ...
        <div class="col-lg-3 mb-4 flipInY wow animated">
          ...
          <div class="row" style="text-align: center">
            <div class="col-md-12">
              ...
              <img src="resources/img/team_profile/kim_dong_hyeon.jpg" alt="wrapkit" class="img-fluid rounded-circle" />
            </div>
            <div class="col-md-12 text-center">
              <div class="pt-2">
        ...
        <div class="col-lg-3 mb-4 flipInY wow animated">
          ...
          <div class="row" style="text-align: center">
            <div class="col-md-12">
              ...
              <img src="resources/img/team_profile/kim_kyung_hyeon.jpg" alt="wrapkit" class="img-fluid rounded-circle" />
            </div>
            <div class="col-md-12 text-center">
              <div class="pt-2">
        ...
        <div class="col-lg-3 mb-4 flipInY wow animated">
          ...
          <div class="row" style="text-align: center">
            <div class="col-md-12">
              ...
              <img src="resources/img/team_profile/o_jae_il.jpg" alt="wrapkit" class="img-fluid rounded-circle" />
            </div>
            <div class="col-md-12 text-center">
              <div class="pt-2">
...
<footer class="footer_section" id="contact">
      ...
      <div class="row">
        <div class="col-lg-6 wow fadeInLeft">
          ...
          <ul class="social-link">
            ...
            <li class="dribbble animated bounceIn wow delay-06s"><a href="javascript:void(0)"><i class="fa fa-dribbble"></i></a></li>
          </ul>
        </div>
  ...
  <div class="container">
    <div class="footer_bottom"> <span>Computer Software Engineering | <a href="https://github.com/DEU-Manito">deu-manito.github.io</a> by DEU-Manito </span> </div>
    <!-- 
