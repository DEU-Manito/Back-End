...
<script>
    <% if(Objects.isNull(profile) || Objects.isNull(grade)) { %>
        alert('유저 정보가 없습니다.');
...
<div class="wrapper">
    <div class="profile-card js-profile-card">
        ...
        <div class="profile-card__cnt js-profile-cnt">
            <div class="profile-card__name"><%=profile.getNickname()%></div>
            ...
            <div class="profile-card-inf">
                ...
                <div class="profile-card-inf__item">
                    ...
                    <div class="profile-card-inf__title counter" data-count="<%=grade.getScore()%>">0</div>
